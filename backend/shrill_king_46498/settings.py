"""
Django settings for shrill_king_46498 project.
...
ROOT_URLCONF = 'shrill_king_46498.urls'
...
WSGI_APPLICATION = 'shrill_king_46498.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_king_46498 API",
    "DESCRIPTION": "API documentation for shrill_king_46498 App",
    "VERSION": "v1",
}
